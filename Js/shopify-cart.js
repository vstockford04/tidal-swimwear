...
/* ============================================================
   COLOUR ALIAS MAP
   The UI shows "Toffee" everywhere for consistency. The map below
   used to translate Toffee→Beige for products whose Shopify variant
   was still named "Beige", but those products have now been renamed
   in Shopify so this map can stay empty.

   If a product is ever set up with a different colour name in Shopify
   than what the UI shows, add an entry here. E.g.:
     'the new product name': { toffee: 'tan' }
   ============================================================ */
...
function injectProductStyles() {
  ...
  style.textContent = `
    ...
    .tidal-cart-checkout:hover { background: #b04935; }
...
function injectDrawerStyles() {
  ...
  style.textContent = `
    ...
    .tidal-cart-checkout {
      ...
      background: #c8553d; color: #f4ede2;
      border: 0;
      cursor: pointer; text-align: center; text-decoration: none;
      font-family: 'Inter', sans-serif; font-size: 11px;
      letter-spacing: 0.28em; text-transform: uppercase;
      transition: background 0.15s; font-weight: 400; box-sizing: border-box;
    }
