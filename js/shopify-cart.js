...
/* ============================================================
   CART DRAWER UI STYLES (consolidated)
   ============================================================ */
function injectProductStyles() {
  ...
  style.textContent = `
    ...
    .tidal-cart-qty-btn:hover {
      background: rgba(15,29,58,0.04);
      border-color: rgba(15,29,58,0.3);
    }
    .tidal-cart-qty-num {
    ...
    .tidal-cart-continue:hover { color: #0f1d3a; }
